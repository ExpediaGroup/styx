 ...
 * a time pasted.
 */
class ConnectionExpirationTracker implements ConnectionUsageTracker {
    private final long connectionExpirationSeconds;
    private final Supplier<Ticker> tickerSupplier;

    ConnectionExpirationTracker(long connectionExpirationSeconds, Supplier<Ticker> tickerSupplier) {
