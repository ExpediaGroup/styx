...
public final class StyxServer {
    ...
    private StyxServer(Builder builder) {
        ...
        MemoryBackedRegistry<com.hotels.styx.api.service.spi.BackendService> backendServicesRegistry = new MemoryBackedRegistry<>();
    ...
    public static final class Builder {
        private final Map<String, com.hotels.styx.api.service.spi.BackendService> routes = new HashMap<>();
