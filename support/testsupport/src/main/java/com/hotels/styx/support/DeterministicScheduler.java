 ...
 * as {@link java.util.concurrent.Executor}s or {@link java.util.concurrent.ExecutorService}s if you just want to control background execution
...
public class DeterministicScheduler implements ScheduledExecutorService {
     ...
     * @author nat
     */
    public static class UnsupportedSynchronousOperationException extends UnsupportedOperationException {
